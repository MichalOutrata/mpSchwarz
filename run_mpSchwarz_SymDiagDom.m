...
RM_Type = "StieltjessDiagDom";          % "Mmtrx" or "StieltjessDiagDom"
...
elseif strcmp(RM_Software,"chop")
    ...
    ChopOptions.subnormal = 1; % do we consider the "subnormal numbers" (1) or we flush them (0)
...
elseif strcmp(RM_Type,"StieltjessDiagDom")
    RM_ScalingTreatDiagonalExplicitly = true;
    RM_ScalingOptions = {RM_ScalingToRange,RM_RescaleType,RM_ScalingToRange_Fraction,RM_ScalingTreatDiagonalExplicitly};
end
...
CheckErrMtrcs_PregSplit = true; % whether or not we check the condition mathcalAi_inv >= mathcalAi_inv * F_i * mathcalAi_inv (considered only for "StieltjessDiagDom")    
...
list_of_nmb_int_gridcols = 10:5:50; % number of "unknown" gridcolumns - excluding the left-most and right-most where we have Dirichlet BCs 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            % ConvFactApproxSequence1 = ( ConsecErrsRatio(1:end-1) + ConsecErrsRatio(2:end) ) / 2; % original, additive smoothing of the ConvFactr due to having 2 subdomains nto perfectly symmetrical
...
s_SaveString = "SavedData_mpSM_" + SpecialStrngForNamingOutput + "_" + RM_Software + ".mat";
