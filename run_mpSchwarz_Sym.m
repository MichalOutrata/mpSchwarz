...
elseif strcmp(RM_Software,"chop")
    RM_Precision_list = {'q52','q43','bfloat16','fp16','fp32','fp64'}; %{'q43','bfloat16','fp16'}; {'q52','q43','bfloat16','fp16','fp32','fp64'}; % precision format of chop for the subdomain solves
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    if ProblemChoice == 0 %%% do negative laplacian
        ...
        u_plot = zeros(nmb_int_gridcols+2); angle1 = 52.5; angle2 = 30; x_mesh = 0:h:1;
