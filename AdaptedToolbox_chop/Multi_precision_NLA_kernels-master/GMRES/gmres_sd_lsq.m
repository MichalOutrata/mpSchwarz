function [x, error, its, flag] = gmres_sd_lsq( A, x, b, L, U, restrt, max_it, tol)
%GMRES_SD_LSQ   Left-preconditioned GMRES in single/double precision
...
for iter = 1:max_it,                              % begin iteration
    ...
    for i = 1:m,                     % construct orthonormal basis via GS
        ...
        vcur = double(U)\(double(L)\(double(A')*(double(A)*double(vcur))));
